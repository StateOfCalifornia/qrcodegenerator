...
/// <summary>Diagnostics for the JwtBearer middleware (used in Web APIs)</summary>
public static class MyJwtBearerDiagnosticsMiddleware
{
    ...
    /// <summary>Invoked after the security token has passed validation and a ClaimsIdentity has been generated.</summary>
    ...
    #region JwtBearer Static Custom Events
    ...
    static async Task OnAuthenticationFailed(AuthenticationFailedContext context)
    {
        ...
        Debug.WriteLine($"99. Error is : {context.Exception.Message}");
    ...
    static async Task OnTokenValidated(TokenValidatedContext context)
    {
        ...
        Debug.WriteLine($"Authenticated User Name : {context.Principal.Identity.Name}");
